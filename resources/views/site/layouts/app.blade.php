...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="{{ url('/')}}">Neub</a></h1>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>North East University Bangaldesh</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Customized by <a href="https://web.facebook.com/mubarak.yt">Mubarak Hussain</a>
        </div>
      </div>
