    ...
    <div id="trainers" class="trainers">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          @endif
                <form action="{{ route('add.payment') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="reg_no" id="" class="form-control" class="@error('reg_no') is-invalid @enderror" placeholder="Enter Reg_No" >
                        </div>
                    </div>
                    @error('reg_no')
                    <p class="text-danger text-capitalize">{{ $message }}</p>
